...
def segment(net, path, bgimagepath, show_orig=True, dev='cpu'):
  img = Image.open(path)
...
segment(dlab, 'mustang-acv.png','black-burst.png', show_orig=True)
segment(dlab, 'black-car.png','black-burst.png', show_orig=True)